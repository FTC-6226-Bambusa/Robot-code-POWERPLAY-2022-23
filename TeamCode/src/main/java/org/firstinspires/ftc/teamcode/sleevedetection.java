...
public class sleevedetection extends OpenCvPipeline {
    ...
    private ParkingPosition position = ParkingPosition.LEFT;
    ...
    public Mat processFrame(Mat input) {
        ...
        telemetry.addData("[yelPercent]", sumColors.val[2]);
        telemetry.addData("[cyaPercent]", sumColors.val[0]);
        telemetry.addData("[magPercent]", sumColors.val[1]);
        telemetry.update();
        return input;
    }
